 ...
 */
final class Version20240423101652 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE event ADD one_to_many VARCHAR(255) NOT NULL');
        $this->addSql('ALTER TABLE inscription ADD user_id INT NOT NULL, ADD event_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE inscription DROP user_id, DROP event_id');
        $this->addSql('ALTER TABLE event DROP one_to_many');
    }
}
