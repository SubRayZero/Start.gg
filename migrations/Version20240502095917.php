 ...
 */
final class Version20240502095917 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE event ADD CONSTRAINT FK_3BAE0AA7E13113B2 FOREIGN KEY (ranked_id) REFERENCES `rank` (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
